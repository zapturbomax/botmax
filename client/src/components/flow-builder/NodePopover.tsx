...
import { Plus, MessageCircle, Image, List, ArrowRight, X, Edit, Copy, Trash2 } from 'lucide-react';
...
export function NodePopover({ node, onUpdate, onAddBlock, onDelete, onDuplicate }: NodePopoverProps) {
        ...
        <div>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-32 py-1">
              <DropdownMenuItem onClick={() => setOpen(true)} className="py-0.5 px-2 text-xs">
